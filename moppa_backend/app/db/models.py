...
class QuestionEntity(Base):
    ...
    event_domain: Mapped[str | None] = mapped_column(String(100), nullable=True)
...
class QuestionTemplateEntity(Base):
    ...
    id: Mapped[UUID] = mapped_column(PGUUID(as_uuid=True), primary_key=True, server_default=text("gen_random_uuid()"))
    template_index: Mapped[int] = mapped_column(Integer)
    question_template: Mapped[str] = mapped_column(Text)
    difficulty_level: Mapped[str] = mapped_column(String(2))
    candidate_answer_type: Mapped[str] = mapped_column(String(20))
    event_domain: Mapped[str] = mapped_column(String(100))
    event_type: Mapped[str] = mapped_column(String(100))
    event_type_id: Mapped[str] = mapped_column(String(20))
    operation_level: Mapped[str] = mapped_column(String(50))
    status: Mapped[str] = mapped_column(String(20), server_default=text("'active'"))
    version: Mapped[str] = mapped_column(String(20), server_default=text("'v1.0'"))
...
class AppUserEntity(Base):
    ...
    permissions: Mapped[dict[str, object]] = mapped_column(JSONB, server_default=text("'{}'::jsonb"))
...
class AuthRefreshTokenEntity(Base):
