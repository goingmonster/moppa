...
BASE_URL = "http://172.16.18.11:18081/api"
TOKEN = "sk-92df8b74049920084a02dae8f79f6df5095b72df"
HEADERS = {
...
# ---- 1. 提交预测 ----
submit_payload = {
    "id": "b2fe8cd8-7376-4e44-ab32-828953b03bde",
    "question": "这是一个测试问题",
